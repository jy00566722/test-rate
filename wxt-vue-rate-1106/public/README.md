...
速卖通:
- https://www.aliexpress.com/    (使用时注意切换货币单位为美元，后续会支持更多货币)(停止支持,因为访客不能看到详情页)
...
韩国Gmarket
- https://www.gmarket.co.kr (韩国Gmarket)
...
同时也提供手动输入数字转换货币的功能，可以互转货币共有162种。

### 关于汇率：
         汇率是每12小时更新一次。(以前是每40分钟一次,但接口太贵)

### 关于效率：
         插件不会持续操作页面造成卡顿，只有在页面内容有更新时才启动，放心使用。

### 关于安全：
       插件不会记录用户的任何数据，有 Google/360/微软 审查。
...
```
- 3.2.0.0    2023年11月07日 主界面优化,整体用wxt改造 
- 3.1.1.2    2023年10月18日 增加亚马逊 印度 站的页面价格转换
- 3.1.1.0    2023年9月26日  增加wowmajp 的价格转换支持.同样需要手动授权开启。
- 3.1.0.0    2023年5月15日  所有站点的价格转换,需要手动开启.(如后续有更新或问题,请再次手动开启一次)。为了保持最小的请求权限.
- 3.0.5.0    2023年5月3日   增加TEMU站的支持,需要手动点击开启权限. 取消Aliexpress的支持,因为Aliexpress要登陆才可以看到价格。
- 3.0.4.0    2023年4月30日  增加韩国Gmarket站的支持,需要手动点击开启权限.
- 3.0.3.0    2022年11月9日  主界面增加反馈按钮,可以及时反馈异常。POP页面去掉下面的小字1USD=xxx类,使界面更简洁.
